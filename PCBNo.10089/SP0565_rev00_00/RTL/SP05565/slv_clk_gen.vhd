...
constant c_CNT10us	: std_logic_vector(2 downto 0) := "100";		-- 500 kHz / 100 kHz - 1
...
signal s_CNT100k	: std_logic_vector(2 downto 0);
	...
	begin
		if (RSTb = '0') then
			...
			if (s_CKEN500k = '1') then
				s_CNT100k <= s_CNT100k + 1;
				if (s_CNT100k =  c_CNT10us ) then
					s_CNT100k <= (others => '0');
					s_CKEN100k <= '1';
				else
					s_CKEN100k <= '0';
