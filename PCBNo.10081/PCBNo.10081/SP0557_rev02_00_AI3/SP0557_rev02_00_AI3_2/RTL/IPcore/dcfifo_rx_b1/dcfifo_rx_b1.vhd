...
-- Module  Version: 5.8
--C:\lscc\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n dcfifo_rx_b1 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 64 -width 11 -rwidth 11 -reset_rel SYNC -pe -1 -pf -1 -fdc C:/work/S127M/PCBNo_10081/SP0557_rev02_00/RTL/IPcore/dcfifo_rx_b1/dcfifo_rx_b1.fdc 

-- Wed Jan 28 14:53:45 2026
...
architecture Structure of dcfifo_rx_b1 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "dcfifo_rx_b1.lpc";
...
begin
    ...
    pdp_ram_0_0_0: DP16KD
        ...
        port map (DIA17=>scuba_vlo, DIA16=>scuba_vlo, DIA15=>scuba_vlo, 
            ...
            DIA11=>scuba_vlo, DIA10=>Data(10), DIA9=>Data(9), 
